  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[230px_1fr]">
      ...
      <section className="space-y-4">
        ...
        {activeMenu === "TEACHING SCHEDULE" && (
          <article className="rounded-xl border border-blue-100 bg-white p-4">
            <p className="mb-3 text-sm font-bold text-slate-900">Teaching Availability</p>
        ...
        {(activeMenu === "LICENSE INFO" || activeMenu === "SUBSCRIPTION" || activeMenu === "SECURITY") && (
          <article className="rounded-xl border border-blue-100 bg-white p-6">
            <h2 className="text-lg font-bold text-slate-900">{activeMenu}</h2>
