  ...
  en: {
    translation: {
      ...
      instructorProfile: {
        ...
        descriptions: {
          licenseInfo: "Your assigned training license setup.",
          accountSecurity:
            "Update your password to keep your account protected.",
          subscription:
            "Plan and billing overview for your instructor account.",
        },
        actions: {
        ...
        messages: {
          ...
          notificationsSaved: "Notification preferences were saved locally.",
          avatarImageOnly: "Please select an image file.",
          avatarTooLarge: "Avatar must be smaller than 2MB.",
          avatarReadFailed: "Cannot read selected image.",
        },
      },
      studyPreferences: {
      ...
      dashboardPage: {
        ...
        latestTestOnlyDesc:
          "This card only shows your most recently completed exam.",
        lastAttemptAt: "Last attempt:",
        noAttemptTime: "No attempt time",
    ...
    translation: {
      ...
      instructorProfile: {
        sidebar: {
          ...
          manageProfile: "Quản lý hồ sơ chuyên môn của bạn",
        },
        menu: {
          profileDetails: "CHI TIẾT HỒ SƠ",
          licenseInfo: "THÔNG TIN BẰNG",
          security: "BẢO MẬT",
          subscription: "GÓI ĐĂNG KÝ",
        },
        sections: {
        ...
        descriptions: {
          licenseInfo: "Thông tin hạng bằng được phân công cho giảng viên.",
          accountSecurity: "Cập nhật mật khẩu để bảo vệ tài khoản của bạn.",
          subscription:
            "Tổng quan gói và thông tin thanh toán tài khoản giảng viên.",
        },
        actions: {
        ...
        common: {
          ...
          na: "Không có",
          defaultLicense: "A1",
          proInstructor: "Giảng viên Pro",
          active: "Đang hoạt động",
        },
        messages: {
          loginAgain: "Vui lòng đăng nhập lại để tiếp tục.",
          loadFailed: "Không thể tải dữ liệu hồ sơ.",
          fullNameMin: "Họ tên phải có ít nhất 2 ký tự.",
          ...
          notificationsSaved: "Đã lưu cài đặt thông báo cục bộ.",
          avatarImageOnly: "Vui lòng chọn tệp hình ảnh.",
          avatarTooLarge: "Ảnh đại diện phải nhỏ hơn 2MB.",
          avatarReadFailed: "Không thể đọc ảnh đã chọn.",
        },
      },
      studyPreferences: {
      ...
      dashboardPage: {
        ...
        latestTestOnlyDesc: "Thẻ này chỉ hiển thị đề bạn vừa làm gần nhất.",
        lastAttemptAt: "Lần làm gần nhất:",
        noAttemptTime: "Chưa có thời gian làm",
